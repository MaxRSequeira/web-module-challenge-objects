...
console.log("task 1 a", createMenuItems('tacos',8, 'lunch'));
...
*/
reviews.push({name: 'Nebuchadnezzar', rating: 5, feedback: 'awesome cheesesteak shawarma'})
...
/*
maybe reverse engineer something like this?
